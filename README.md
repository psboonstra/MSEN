...
<samp>functions.R</samp> provides all of the necessary functions to fit the (i) multistep elastic net, (ii) the IPF Lasso (i.e. a multistep elastic net with tuning parameter &lambda; set to 1), and (iii) the (sparse) group lasso. 
